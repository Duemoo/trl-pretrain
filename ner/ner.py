...
def ner_in_batch_spacy(text: list) -> dict:
    output = {}
    # To use spaCy in GPU
    spacy.prefer_gpu()
    ...
    ner_outputs = ner_model.pipe(text, n_process=2)
